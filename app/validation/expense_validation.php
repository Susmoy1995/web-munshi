<?php 
	...
	function expense_validation($topic, $val, $details) {
		$error_log = array();
		...
		if(count($error_log) == 0) {
			...
			$date = date('Y-m-d');
			$sql = "INSERT INTO expense_record VALUES (NULL, '".$topic."', '".$details."', '".$val."', '".$date."', ".$_SESSION["user_id"].")";

			if(mysqli_query($conn, $sql)) {
				$error_log["item_add"] = "New expense added";
			} else {
